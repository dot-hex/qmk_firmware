...
=======
        MO(_FN2), _______, _______, _______, _______, _______,                                        _______, _______, UG_PREV,  UG_NEXT, UG_TOGG, MO(_FN2),
        _______,  _______, KC_MUTE, KC_VOLD, KC_VOLU,                                                          UG_VALU, UG_VALD,  UG_SATU, UG_SATD, _______,
                                                               _______, _______,    _______, _______,
                                                                        _______,    UG_HUEU,
                                                      _______, _______, _______,    UG_HUED, _______, _______
>>>>>>> upstream/master
    ),
    [_FN2] = LAYOUT(
        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                                          KC_F7,   KC_F8,   KC_F9,    KC_F10,  KC_F11,  KC_F12,
...
<<<<<<< HEAD
        ...
        _______, _______, KC_MUTE, KC_VOLD, KC_VOLU,                                                          RGB_VAI, RGB_VAD,  RGB_SAI, RGB_SAD, _______,
                                                     ...
                                                     _______, _______, _______,    RGB_HUD, _______, _______
=======
        _______, _______, _______, QK_BOOT, _______, _______,                                        _______, _______, QK_BOOT,  _______, _______, _______,
        _______, _______, _______, _______, _______, _______,                                        _______, _______, UG_PREV,  UG_NEXT, UG_TOGG, _______,
        _______, _______, KC_MUTE, KC_VOLD, KC_VOLU,                                                          UG_VALU, UG_VALD,  UG_SATU, UG_SATD, _______,
                                                              _______, _______,    _______, _______,
                                                                       _______,    UG_HUEU,
                                                     _______, _______, _______,    UG_HUED, _______, _______
