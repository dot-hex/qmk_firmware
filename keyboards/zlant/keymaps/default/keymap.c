...
=======
    UG_HUEU, UG_HUED, KC_LGUI, KC_LALT, KC_LSFT, KC_SPC,  KC_SPC,  MO(1),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
>>>>>>> upstream/master
  ),
  /*  BASE LAYER
   * ┌──────┬──────┬──────┬──────┬──────┬──────┬──────┬──────┬──────┬──────┬──────┬──────┐
...
=======
    UG_VALU, UG_VALD, QK_BOOT, KC_PSCR, _______, _______, _______, _______, KC_PGDN, KC_END,  _______, KC_DEL
>>>>>>> upstream/master
  )
};  
  /*  FN LAYER
