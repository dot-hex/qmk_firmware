...
* |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------|
<<<<<<< HEAD
* | LCTRL| LOS  | LALT |   /  |   `  |   -  |  =   |  [   |TT(1) |LT(SPC)|   ]  | MENU | RALT | ROS  |RCTRL | CAPS |RESET |
* '-----------------------------------------------------------------------------------------------------------------------'
*/
[0] = LAYOUT_grid(
  ...
  KC_LCTRL,      KC_LGUI,    KC_LALT, KC_BSLS, KC_GRV, KC_MINS, KC_EQL,  KC_LBRC, TT(1),   LT(2, KC_SPC), KC_RBRC,    KC_MENU, KC_RALT, KC_RGUI,  KC_RCTRL, KC_CAPS, RESET
=======
...
[2] = LAYOUT_grid(
  ...
  RESET, RGB_TOG,  _______, _______, _______, _______,   _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_MOD, RGB_RMOD
=======
