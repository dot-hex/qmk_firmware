...
<<<<<<< HEAD:keyboards/unikeyboard/divergetm2/keymaps/default/keymap.c
  RESET,  KC_LCTL, KC_LALT, KC_LGUI, LT(_LOWER, KC_SPC), LT(_RAISE,KC_SPC), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
=======
  QK_BOOT, KC_LCTL, KC_LALT, KC_LGUI, LT(_LOWER, KC_SPC), LT(_RAISE,KC_SPC), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
>>>>>>> upstream/master:keyboards/divergetm2/keymaps/default/keymap.c
),
