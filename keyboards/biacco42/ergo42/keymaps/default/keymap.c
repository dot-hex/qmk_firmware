...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [META] = LAYOUT(
<<<<<<< HEAD:keyboards/biacco42/ergo42/keymaps/default/keymap.c
...
=======
    ...
    _______, KC_F1,   XXXXXXX, KC_INT5, KC_INT4, XXXXXXX, XXXXXXX,    KC_LEFT,    KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, XXXXXXX, _______,
>>>>>>> upstream/master:keyboards/ergo42/keymaps/default/keymap.c
