...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_ortho5(
<<<<<<< HEAD
        KC_MUTE, KC_ESC,                                                                                     RGB_HUI, RGB_VAI, RGB_SAI,
=======
        KC_MUTE, KC_ESC,                                                                                     UG_HUEU, UG_VALU, UG_SATU,
>>>>>>> upstream/master
...
=======
        QK_BOOT, UG_TOGG,                                                                                     UG_HUED,  UG_VALD, UG_SATD,
>>>>>>> upstream/master
    ...
    [_NUMBRS] = LAYOUT_ortho5(
<<<<<<< HEAD
        KC_MUTE, KC_GRAVE,                                                                                      RGB_HUI, RGB_VAI, RGB_SAI,
=======
        KC_MUTE, KC_GRAVE,                                                                                      UG_HUEU, UG_VALU, UG_SATU,
>>>>>>> upstream/master
