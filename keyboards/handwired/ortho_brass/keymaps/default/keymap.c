...
[_QWERTY] = LAYOUT_ortho_4x12_1x2uC(
    ...
    XXXXXXX, KC_LCTL, KC_LALT, KC_LGUI, LOWER,       KC_SPC,       RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
<<<<<<< HEAD
=======
<<<<<<<< HEAD:keyboards/handwired/ortho_brass/keymaps/default/keymap.c
>>>>>>> upstream/master
...
bool encoder_update_user(uint8_t index, bool clockwise) {
    if (clockwise) {
      ...
      #endif
>>>>>>>> upstream/master:keyboards/planck/keymaps/synth_sample/keymap.c
>>>>>>> upstream/master
    }
    return true;
}
