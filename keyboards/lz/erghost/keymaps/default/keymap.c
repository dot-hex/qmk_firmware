...
>>>>>>> upstream/master
        ...
        KC_LSFT,   KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    MO(1),   KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT, KC_LSFT,            KC_UP,
        KC_LCTL,   KC_LGUI, KC_LALT, KC_APP,  KC_SPC,  KC_SPC,  KC_SPC,  KC_SPC,  KC_LALT, KC_LGUI, MO(1),   KC_LCTL,                              KC_LEFT, KC_DOWN, KC_RGHT
    ),
};
