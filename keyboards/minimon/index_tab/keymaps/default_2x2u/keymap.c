...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_2x2u(
       ...
       KC_ESC,  KC_GRV,  KC_LGUI, KC_LALT,      KC_SPC,           KC_SPC,      TG(1),   KC_BSLS, KC_LEFT, KC_DOWN, KC_RGHT
    ),
...
>>>>>>> upstream/master
       ...
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_MPLY,          KC_MPLY,     KC_TRNS, KC_P0,   KC_P0,   KC_PDOT, KC_PENT
    ),
