...
=======
    UG_TOGG,  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,  KC_DEL,
    UG_NEXT,  _______,  _______, KC_UP,  _______, _______, _______,          UG_SATU, UG_HUEU, UG_VALU, _______, _______, _______, _______, _______,
    UG_PREV,  _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,          UG_SATD, UG_HUED, UG_VALD, _______, _______, _______,          _______,
