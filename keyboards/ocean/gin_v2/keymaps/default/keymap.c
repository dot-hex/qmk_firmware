...
<<<<<<< HEAD
    KC_P0, KC_PDOT, KC_PENT,  KC_LCTRL, KC_LGUI, KC_LALT,   KC_SPC,     KC_SPC,  MO(1),   KC_RALT, KC_RGUI, KC_RCTRL
=======
    KC_P0, KC_PDOT, KC_PENT,  KC_LCTL, KC_LGUI, KC_LALT,   KC_SPC,     KC_SPC,  MO(1),   KC_RALT, KC_RGUI, KC_RCTL
>>>>>>> upstream/master
  ),
