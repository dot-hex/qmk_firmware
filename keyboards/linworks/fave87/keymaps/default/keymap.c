...
>>>>>>> upstream/master
  ...
  [1] = LAYOUT_all(
<<<<<<< HEAD
    RGB_TOG,            RGB_VAD,  RGB_VAI,  BL_DEC,   BL_INC,   RGB_HUD,  RGB_HUI,  RGB_SAD,  RGB_SAI,  RGB_RMOD, RGB_MOD,  RGB_SPI,  RGB_SPI,                KC_TRNS, KC_TRNS, KC_TRNS,
...
=======
    UG_TOGG,            UG_VALD,  UG_VALU,  BL_DOWN,  BL_UP,    UG_HUED,  UG_HUEU,  UG_SATD,  UG_SATU,  UG_PREV,  UG_NEXT,  UG_SPDD,  UG_SPDU,                KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS,
