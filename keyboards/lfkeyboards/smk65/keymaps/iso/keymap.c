...
=======
     * |MuMode | |  |  |E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]| QK_BOOT| Del|
>>>>>>> upstream/master
     * |--------------------------------------------------------.   |----|
...
=======
        MU_NEXT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          UG_TOGG,
        AU_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, QK_BOOT, UG_NEXT,
        _______, _______, _______, _______, _______, _______, _______, _______, MU_TOGG, UG_VALD, UG_VALU, _______, _______, UG_HUEU, _______,
