...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
<<<<<<< HEAD:keyboards/takashiski/otaku_split/rev0/keymaps/default/keymap.c
...
>>>>>>> upstream/master:keyboards/otaku_split/rev0/keymaps/default/keymap.c
			...
			KC_LSFT,  KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,             KC_B,  KC_N,  KC_M,  KC_COMM, KC_DOT, KC_SLASH,KC_INT1,KC_RSFT,
