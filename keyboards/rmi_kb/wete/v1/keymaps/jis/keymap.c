...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_jis_rhnp(
<<<<<<< HEAD:keyboards/rmi_kb/wete/v1/v1/keymaps/jis/keymap.c
...
>>>>>>> upstream/master:keyboards/rmi_kb/wete/v1/keymaps/jis/keymap.c
  ...
  [1] = LAYOUT_jis_rhnp(
      ...
      KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO, KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO,  KC_NO, KC_NO,
         KC_NO,     KC_NO,          KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, BL_OFF, BL_DOWN,BL_UP,  BL_ON
  )
};
