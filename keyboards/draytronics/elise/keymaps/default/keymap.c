...
=======
        ...
        _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
        UG_HUEU,          UG_SATU, UG_VALU, UG_NEXT, _______, _______, _______, _______, _______, _______, _______, KC_MPLY, KC_VOLU, KC_MUTE,
        UG_HUED, UG_SATD, UG_VALD,                   UG_TOGG,                            _______, KC_TRNS, _______, KC_MPRV, KC_VOLD, KC_MNXT
>>>>>>> upstream/master
    ),
};
