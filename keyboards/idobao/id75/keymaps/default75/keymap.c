...
<<<<<<< HEAD:keyboards/idobao/id75/keymaps/default75/keymap.c
...
=======
    ...
    _______, _______, RM_TOGG, MO(_FN), RM_PREV, RM_NEXT, KC_P0,   _______, KC_PDOT, KC_PENT, KC_PENT, MO(_FN), _______, _______, _______
>>>>>>> upstream/master:keyboards/idobo/keymaps/default75/keymap.c
 ),
};
