...
<<<<<<< HEAD:keyboards/coarse/vinta/keymaps/default/keymap.c
  KC_LCTL, KC_LGUI,KC_LALT,                KC_SPC,                         KC_RALT, RESET,            KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
=======
  KC_LCTL, KC_LGUI,KC_LALT,                KC_SPC,                         KC_RALT, QK_BOOT,          KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
>>>>>>> upstream/master:keyboards/vinta/keymaps/default/keymap.c
};
