...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_64_ansi(
        ...
        RM_NEXT, RM_HUEU, RM_HUED, RM_SATU, RM_SATD, RM_VALU, RM_VALD, RM_SPDU, RM_SPDD, _______, _______,_______, _______,
...
<<<<<<< HEAD:keyboards/mt64rgb/keymaps/default/keymap.c
...
>>>>>>> upstream/master:keyboards/mt/mt64rgb/keymaps/default/keymap.c
