...
=======
                   KC_LCTL,          KC_LALT,      KC_SPC,      MO(_FN),                      KC_SPC,           KC_MENU,                   KC_RCTL
    ),
    [_FN] = LAYOUT_alice_split_bs(
        _______,   _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,      KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_DEL,
        _______,   UG_TOGG, UG_NEXT, UG_PREV, _______, _______, _______,             BL_TOGG, BL_STEP, BL_BRTG, KC_UP,   _______, _______, _______, _______,
        _______,   _______, UG_HUED, UG_HUEU, _______, _______, _______,             _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
        QK_BOOT,   _______, UG_VALD, UG_VALU, _______, _______, _______,             _______, _______, _______, _______, _______, _______, _______, _______,
>>>>>>> upstream/master
